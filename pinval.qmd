...
leaflet_comp_df <- comp_df %>%
  mutate(color = ifelse(comp_pin == params$pin, 0, comp_num))

comp_palette <- colorBin(
  # TODO: This palette could be clearer
  c("black", "#00FF00", "#00CC00", "#009900", "#006600", "#003300"),
  c(0, 1, 2, 3, 4, 5),
)
...
leaflet() %>%
  ...
  # TODO: Add labels with sale price, month, and year
  addCircleMarkers(
  ...
  setView(
    lng = mean(comp_df$loc_longitude),
    lat = mean(comp_df$loc_latitude),
    zoom = 12
  )
```
