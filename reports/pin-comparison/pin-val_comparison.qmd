...
if (any(value$total_cards %in% c(2, 3), na.rm = TRUE)) {
  cat("If PIN has 2 or 3 cards, we select values from the card with a larger sq. footage. Ties are broke by the lower pin number. Square footage is summed in accordance with our modeling technique.\n")
}
