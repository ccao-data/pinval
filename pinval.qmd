...
if (cache_files %>% sapply(file.exists) %>% all()) {
  ...
  school_geoid_pred_idxs <- which(all_predictors_raw %in% c("loc_school_elementary_district_geoid", "loc_school_secondary_district_geoid"))
  all_predictors <- all_predictors_raw %>% replace(school_geoid_pred_idxs, c("loc_school_elementary_district_name", "loc_school_secondary_district_name"))
